 ...
 */
(function (C, T) {
  typeof module === "object" && module.exports ? module.exports = C.document ? T(C) : T : C.Highcharts = T(C)
  ...
  function K(a, b, c) {
    var d, e;
    if (ta(b))r(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b)); else if (r(b) && ba(b))for (d in b)a.setAttribute(d, b[d]);
    return e
  }
  ...
  function ca(a, b, c, d, e) {
    a = A.createElement(a);
    b && q(a, b);
    e && F(a, {padding: 0, border: "none", margin: 0});
    c && F(a, c);
    d && d.appendChild(a);
    return a
  }
  ...
  function wb() {
    var a =
      H.global, b = a.useUTC, c = b ? "getUTC" : "get", d = b ? "setUTC" : "set";
    xa = a.Date || C.Date;
  ...
  mb.prototype = {
    dSetter: function () {
      ...
      if (c.attr && !c.element)c = !1; else if (a || b >= f +
        this.startTime) {
        this.now = this.end;
        this.pos = 1;
        this.update();
  ...
  var q = t.extend = function (a, b) {
    ...
    for (b = 0; b < d; b++)if (c = a[b], c !== w && c !== null)return c
  ...
  Oa = function (a, b, c) {
    ...
    var a = p(a, "%Y-%m-%d %H:%M:%S"), d = new xa(b - (nb && nb(b) || xb || 0) * 6E4), e, f = d[zb](), g = d[Ab](), h = d[Bb](), i = d[ob](), j = d[pb](), k = H.lang, l = k.weekdays, d = q({
      a: l[g].substr(0, 3),
      A: l[g],
      d: Ga(h),
      e: h,
  ...
  jb = {millisecond: 1, second: 1E3, minute: 6E4, hour: 36E5, day: 864E5, week: 6048E5, month: 24192E5, year: 314496E5};
  t.numberFormat = function (a, b, c, d) {
    var e = H.lang, a = +a || 0, f = b === -1 ? Math.min((a.toString().split(".")[1] || "").length, 20) : isNaN(b = Math.abs(b)) ? 2 : b, b = c === void 0 ? e.decimalPoint : c, d = d === void 0 ?
      e.thousandsSep : d, e = a < 0 ? "-" : "", c = String(D(a = Q(a).toFixed(f))), g = c.length > 3 ? c.length % 3 : 0;
  ...
  Ka = function (a) {
    for (var b = Ca.length; b--;)if (Ca[b].elem === a)Ca[b].stopped = !0
  };
  n = function (a, b) {
  ...
  M = function (a, b, c, d) {
    ...
    e = a.hcEvents;
    var f, g, h, i, c = c || {};
    if (A.createEvent && (a.dispatchEvent || a.fireEvent))e = A.createEvent("Events"), e.initEvent(b, !0, !0), e.target = a, q(e, c), a.dispatchEvent ? a.dispatchEvent(e) : a.fireEvent(b, e); else if (e) {
      e = e[b] || [];
      f = e.length;
      h = function () {
  ...
  Ta = function (a,
                 b, c) {
    var d, e = "", f, g, h;
    ba(c) || (d = arguments, c = {duration: d[2], easing: d[3], complete: d[4]});
  ...
  if (C.jQuery)C.jQuery.fn.highcharts = function () {
    ...
    if (this[0])return a[0] ?
      (new (t[ta(a[0]) ? a.shift() : "Chart"])(this[0], a[0], a[1]), this) : Y[K(this[0], "data-highcharts-chart")]
  };
  ...
  P.prototype = {
    parsers: [{
      ...
      if (this.stops)n(this.stops, function (b) {
        b.brighten(a)
      }); else if (ma(a) && a !== 0)for (b = 0; b < 3; b++)c[b] += D(a * 255), c[b] < 0 && (c[b] = 0), c[b] > 255 && (c[b] = 255);
      return this
  ...
  J.prototype = {
    ...
    colorGradient: function (a, b, c) {
      var d = this.renderer, e, f, g, h, i, j, k, l, m, o, u, s = [], p;
      ...
      if (f) {
        ...
        f === "radialGradient" && o && !r(g.gradientUnits) && (h = g, g = B(g, d.getRadialAttr(o, h), {gradientUnits: "userSpaceOnUse"}));
        for (u in g)u !== "id" && s.push(u, g[u]);
        for (u in k)s.push(k[u]);
        s = s.join(",");
        i[s] ? o = i[s].attr("id") : (g.id = o = "highcharts-" + rb++, i[s] = j = d.createElement(f).attr(g).add(d.defs), j.radAttr = h, j.stops = [], n(k, function (a) {
    ...
    applyTextShadow: function (a) {
      var b = this.element, c, d = a.indexOf("contrast") !== -1, e = {}, f = this.renderer.forExport, g = f || b.style.textShadow !== w && !va;
    ...
    css: function (a) {
      ...
      if (e) {
        ...
        if (va && !ea)F(this.element, a); else {
          b = function (a, b) {
    ...
    updateTransform: function () {
      var a = this.translateX ||
        0, b = this.translateY || 0, c = this.scaleX, d = this.scaleY, e = this.inverted, f = this.rotation, g = this.element;
    ...
    getBBox: function (a, b) {
      ...
      e = this.textStr;
      var j, k = h.style, l, m = d.cache, o = d.cacheKeys, u;
      f = p(b, this.rotation);
      g = f * ja;
    ...
    zIndexSetter: function (a, b) {
      ...
      if (e) {
        ...
        d = c.childNodes;
        for (i = 0; i < d.length && !h; i++)if (e = d[i], f = K(e, "zIndex"), e !== g && (D(f) > a || !r(a) && r(f)))c.insertBefore(g, e), h = !0;
        h || c.appendChild(g)
      }
      return h
    },
  ...
  la.prototype = {
    Element: J, init: function (a, b, c, d, e, f) {
      ...
      this.createElement("desc").add().element.appendChild(A.createTextNode("Created with Highmaps 4.2.0"));
      ...
      if (Ja && a.getBoundingClientRect)this.subPixelFix = b = function () {
        ...
        F(a, {left: ra(h.left) - h.left + "px", top: ra(h.top) - h.top + "px"})
      }, b(), G(C, "resize", b)
    }, getStyle: function (a) {
      return this.style = q({
      ...
      !f && !o && !u && e.indexOf(" ") === -1 ? b.appendChild(A.createTextNode(E(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, R && R.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) :
        [e], e[e.length - 1] === "" && e.pop(), n(e, function (e, f) {
        var g, m = 0, e = e.replace(/<span/g, "|||<span").replace(/<\/span>/g, "</span>|||");
        g = e.split("|||");
        n(g, function (e) {
          if (e !== "" || g.length === 1) {
            var o = {}, s = A.createElementNS(Ba, "tspan"), n;
            h.test(e) && (n = e.match(h)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), K(s, "style", n));
            i.test(e) && !d && (K(s, "onclick", 'location.href="' + e.match(i)[1] + '"'), F(s, {cursor: "pointer"}));
            e = E(e.replace(/<(.|\n)*?>/g, "") || " ");
            if (e !== " ") {
              ...
              K(s, o);
              b.appendChild(s);
              !m && f && (!ea && d && F(s, {display: "block"}), K(s, "dy", y(s)));
              if (l) {
      ...
      var j = this.label(a, b, c, i, null, null, null, null, "button"), k = 0, l, m, o, u, s, n, a = {
        x1: 0,
        y1: 0,
        x2: 0,
        y2: 1
      ...
      var e = ba(a) ? a.r : e, g = this.createElement("rect"), a = ba(a) ? a : a === w ? {} : {
        x: a,
        y: b,
        width: v(c, 0),
        height: v(d, 0)
      ...
      if (h)g = this.path(h), q(g, {symbolName: a, x: b, y: c, width: d, height: e}),
      f && q(g, f); else if (i.test(a))k = function (a, b) {
        ...
        onload: function () {
          this.width === 0 && (F(this, {position: "absolute", top: "-999em"}), A.body.appendChild(this));
      ...
      circle: function (a, b, c, d) {
        ...
        var f = e.start, c = e.r || c || d, g = e.end - 0.001,
          d = e.innerR, h = e.open, i = ia(f), j = oa(f), k = ia(g), g = oa(g), e = e.end - f < qb ? 0 : 1;
        return ["M", a + c * i, b + c * j, "A", c, c, 0, e, 1, a + c * k, b + c * g, h ? "M" : "L", a + d * k, b + d * g, "A", d, d, 0, e, 0, a + d * i, b + d * j, h ? "" : "Z"]
      }, callout: function (a, b, c, d, e) {
        var f = I(e && e.r || 0, c, d), g = f + 6, h = e && e.anchorX, e = e && e.anchorY, i;
      ...
      var e = "highcharts-" + rb++, f = this.createElement("clipPath").attr({id: e}).add(this.defs), a = this.rect(a, b, c, d, 0).add(f);
      a.id = e;
      a.clipPath = f;
      a.count = 0;
      return a
    }, text: function (a, b, c, d) {
      var e = ka || !ea && this.forExport, f = {};
      ...
      var d = a;
      b && c && (d = v(d * ia(b * ja), 4));
      return {x: -a / 3 * oa(b * ja), y: d}
    }, label: function (a, b, c, d, e, f, g, h, i) {
      var j = this, k = j.g(i), l = j.text("", 0, 0, g).attr({zIndex: 1}), m, o, u = 0, s = 3, p = 0, y, E, V, v, da = 0, $a = {}, t, A, z, C, D;
      z = function () {
        var a, b;
        a = l.element.style;
        ...
        if (A) {
          ...
          m.isImg || m.attr(q({width: x(k.width), height: x(k.height)}, $a));
          $a = null
        }
      };
      C = function () {
        var a = k.styles, a = a && a.textAlign, b = p + s, c;
        c = h ? 0 : t;
        if (r(y) && o && (a === "center" || a === "right"))b += {center: 0.5, right: 1}[a] * (y - o.width);
      ...
      k.onAdd = function () {
        ...
        m && r(e) && k.attr({anchorX: e, anchorY: f})
      };
      ...
      return q(k, {
        css: function (a) {
          ...
          return {
            width: o.width + 2 *
            s, height: o.height + 2 * s, x: o.x - s, y: o.y - s
          }
        }, shadow: function (a) {
          m && m.shadow(a);
          return k
  ...
  q(J.prototype, {
    htmlCss: function (a) {
      ...
      if (this.added) {
        ...
        if (b.tagName === "SPAN") {
          var k = this.rotation, l, m = D(this.textWidth), o = [k, g, b.innerHTML, this.textWidth, this.textAlign].join(",");
          if (o !== this.cTT) {
      ...
      var d = {}, e = va ? "-ms-transform" : ib ? "-webkit-transform" : Ja ? "MozTransform" : Gb ? "-o-transform" : "";
  ...
  if (!ea && !ka)O = {
    init: function (a, b) {
      var c = ["<", b, ' filled="f" stroked="f"'], d = ["position: ", "absolute", ";"], e = b === Ia;
      ...
      if (this.onAdd)this.onAdd();
      return this
    }, updateTransform: J.prototype.htmlUpdateTransform, setSpanRotation: function () {
      var a = this.rotation, b = ia(a * ja), c = oa(a * ja);
      ...
      var f = d ? ia(d * ja) : 1, g =
        d ? oa(d * ja) : 0, h = p(this.elemHeight, this.element.offsetHeight), i;
      this.xCorr = f < 0 && -a;
      this.yCorr = g < 0 && -h;
      i = f * g < 0;
      ...
      for (var b = a.length, c = []; b--;)if (ma(a[b]))c[b] = x(a[b] * 10) - 5; else if (a[b] === "Z")c[b] = "x"; else if (c[b] = a[b], a.isArc && (a[b] === "wa" || a[b] === "at"))c[b + 5] === c[b + 7] && (c[b + 7] += a[b + 7] > a[b + 5] ? 1 : -1), c[b + 6] === c[b + 8] && (c[b +
      8] += a[b + 8] > a[b + 6] ? 1 : -1);
      return c.join(" ") || "x"
    }, clip: function (a) {
      var b = this, c;
      ...
      return b.css(a)
    }, css: J.prototype.htmlCss, safeRemoveChild: function (a) {
      a.parentNode && Pa(a)
    }, destroy: function () {
      ...
      var d = [], e, f = this.element, g = this.renderer, h, i = f.style, j, k = f.path, l, m, o, u;
    ...
    Element: O, isIE8: ya.indexOf("MSIE 8.0") > -1, init: function (a, b, c, d) {
      var e;
      this.alignedObjects = [];
      d = this.createElement(Ia).css(q(this.getStyle(d), {position: "relative"}));
      e = d.element;
      ...
      if (i) {
        var k, l, m = a.linearGradient || a.radialGradient, o, u, s, p, y, E = "", a = a.stops, V, r = [], da = function () {
        ...
        if (c === "fill")if (i === "gradient")c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, o = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, E = 'angle="' + (90 - N.atan((m - a) / (o - c)) * 180 / qb) + '"', da(); else {
          var j = m.r, q = j * 2, v = j * 2, w = m.cx, t = m.cy, x = b.radialReference, B, j = function () {
            x && (B =
      ...
      } else if (g.test(a) && b.tagName !== "IMG")f = P(a), d[c + "-opacitySetter"](f.get("a"), c, b), j = f.get("rgb"); else {
      ...
      F(a, {
        flip: "x", left: D(d.width) - (e ? D(e.top) :
          1), top: D(d.height) - (e ? D(e.left) : 1), rotation: -90
      });
      ...
      arc: function (a, b, c, d, e) {
        var f = e.start, g = e.end, h = e.r || c || d, c = e.innerR, d = ia(f), i = oa(f), j = ia(g), k = oa(g);
        if (g - f === 0)return ["x"];
  ...
  Qa.prototype = {
    addLabel: function () {
      ...
      r(d) ? d && d.attr({text: b}) : (this.labelLength = (this.label = d = r(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(B(g.style)).add(a.labelGroup) : null) && d.getBBox().width, this.rotation = 0)
    }, getLabelSize: function () {
      return this.label ? this.label.getBBox()[this.axis.horiz ? "height" : "width"] : 0
    }, handleOverflow: function (a) {
      var b =
        this.axis, c = a.x, d = b.chart.chartWidth, e = b.chart.spacing, f = p(b.labelLeft, I(b.pos, e[3])), e = p(b.labelRight, v(b.pos + b.len, d - e[1])), g = this.label, h = this.rotation, i = {
        left: 0,
        center: 0.5,
        right: 1
      }[b.labelAlign], j = g.getBBox().width, k = b.slotWidth, l = 1, m, o = {};
      if (h)h < 0 && c - i * j < f ? m = x(c / ia(h * ja) - f) : h > 0 && c + i * j > e && (m = x((d - c) / ia(h * ja))); else if (d = c + (1 - i) * j, c - i * j < f ? k = a.x + k * (1 - i) - f : d > e && (k = e - a.x + k * i, l = -1), k = I(b.slotWidth, k), k < b.slotWidth && b.labelAlign === "center" && (a.x += l * (b.slotWidth - k - i * (b.slotWidth - I(j, k)))), j > k || b.autoRotation &&
        g.styles.width)m = k;
      if (m) {
        o.width = m;
      ...
      var i = this.axis, j = i.transA, k = i.reversed,
        l = i.staggerLines, m = i.tickRotCorr || {x: 0, y: 0}, o = e.y;
      ...
      var d = this.axis, e = d.options, f = d.chart.renderer, g = d.horiz, h = this.type, i = this.label, j = this.pos, k = e.labels, l = this.gridLine,
        m = h ? h + "Grid" : "grid", o = h ? h + "Tick" : "tick", u = e[m + "LineWidth"], s = e[m + "LineColor"], n = e[m + "LineDashStyle"], y = e[o + "Length"], m = p(e[o + "Width"], !h && d.isXAxis ? 1 : 0), E = e[o + "Color"], V = e[o + "Position"], o = this.mark, r = k.step, da = !0, q = d.tickmarkOffset, v = this.getPosition(g, j, q, b), t = v.x, v = v.y, x = g && t === d.pos + d.len || !g && v === d.pos ? -1 : 1, c = p(c, 1);
      this.isActive = !0;
      if (u) {
      ...
      if (m && y)V === "inside" && (y = -y), d.opposite && (y = -y), h = this.getMarkPath(t, v, y, m * x, g, f), o ? o.animate({
        d: h,
        opacity: c
      }) : this.mark = f.path(h).attr({stroke: E, "stroke-width": m, opacity: c}).add(d.axisGroup);
  ...
  Z.prototype = {
    ...
    defaultYAxisOptions: {
      ...
      stackLabels: {
        ...
        }, style: B(X.line.dataLabels.style, {color: "#000000"})
      }
    },
    ...
    setOptions: function (a) {
      this.options = B(this.defaultOptions, this.isXAxis ? {} : this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions,
        this.defaultLeftAxisOptions][this.side], B(H[this.coll], a))
    },
    defaultLabelFormatter: function () {
      var a = this.axis, b = this.value, c = a.categories, d = this.dateTimeLabelFormat, e = H.lang.numericSymbols, f = e && e.length, g, h = a.options.labels.format, a = a.isLog ? b : a.tickInterval;
      if (h)g = Na(h, this); else if (c)g = b; else if (d)g = Oa(d, b); else if (f && a >= 1E3)for (; f-- && g === w;)c = Math.pow(1E3, f + 1), a >= c && b * 10 % c === 0 && e[f] !== null && (g = t.numberFormat(b / c, -1) + e[f]);
    ...
    getLinearTickPositions: function (a, b, c) {
      var d, e = wa(fa(b / a) * a), f = wa(ra(c / a) * a), g = [];
    ...
    setAxisTranslation: function (a) {
      var b = this, c = b.max -
        b.min, d = b.axisPointRange || 0, e, f = 0, g = 0, h = b.linkedParent, i = !!b.categories, j = b.transA, k = b.isXAxis;
      if (k || i || d)if (h ? (f = h.minPointOffset, g = h.pointRangePadding) : (n(b.series, function (a) {
    ...
    setTickInterval: function (a) {
      var b = this, c = b.chart, d = b.options, e = b.isLog, f = b.isDatetimeAxis, g = b.isXAxis, h = b.isLinked, i = d.maxPadding, j = d.minPadding, k = d.tickInterval, l = d.tickPixelInterval, m = b.categories, o = b.threshold, u = b.softThreshold, s, R, y, E;
      ...
      if (u && r(b.dataMin))if (o = o || 0, !r(y) && b.min < o && b.dataMin >= o)b.min = o; else if (!r(E) && b.max > o && b.dataMax <= o)b.max = o;
    ...
    zoom: function (a, b) {
      var c = this.dataMin, d = this.dataMax, e = this.options, f = I(c, p(e.min, c)), e = v(d, p(e.max, d));
    ...
    unsquish: function () {
      var a = this.ticks, b = this.options.labels, c = this.horiz, d = this.tickInterval, e = d, f = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / d), g, h = b.rotation, i = this.chart.renderer.fontMetrics(b.style.fontSize,
        a[0] && a[0].label), j, k = Number.MAX_VALUE, l, m = function (a) {
        a /= f || 1;
        a = a > 1 ? ra(a) : 1;
        return a * d
      };
    ...
    renderUnsquish: function () {
      var a = this.chart, b = a.renderer, c = this.tickPositions, d = this.ticks, e = this.options.labels, f = this.horiz, g = a.margin, h = this.categories ?
        c.length : c.length - 1, g = this.slotWidth = f && (e.step || 0) < 2 && !e.rotation && (this.staggerLines || 1) * a.plotWidth / h || !f && (g[3] && g[3] - a.spacing[3] || a.chartWidth * 0.33), i = v(1, x(g - 2 * (e.padding || 5))), j = {}, h = b.fontMetrics(e.style.fontSize, d[0] && d[0].label), k = e.style.textOverflow, l, m = 0, o, u;
      if (!ta(e.rotation))j.rotation = e.rotation || 0;
      if (this.autoRotation)n(c, function (a) {
        if ((a = d[a]) && a.labelLength > m)m = a.labelLength
      }), m > i && m > h.h ? j.rotation = this.labelRotation : this.labelRotation = 0; else if (g && (l = {width: i + "px"}, !k)) {
        l.textOverflow =
          "clip";
        for (o = c.length; !f && o--;)if (u = c[o], i = d[u].label)if (i.styles.textOverflow === "ellipsis" && i.css({textOverflow: "clip"}), i.getBBox().height > this.len / c.length - (h.h - h.f) || d[u].labelLength > g)i.specCss = {textOverflow: "ellipsis"}
      }
      if (j.rotation && (l = {width: (m > a.chartHeight * 0.5 ? a.chartHeight * 0.33 : a.chartHeight) + "px"}, !k))l.textOverflow = "ellipsis";
    ...
    getOffset: function () {
      var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, j, k, l = 0, m, o = 0, u = d.title, s = d.labels, R = 0, y = a.opposite, E = b.axisOffset, b = b.clipOffset, V = [-1, 1, 1, -1][h], q, da = a.axisParent;
      j = a.hasData();
      a.showAxis = k = j || p(d.showEmpty, !0);
      a.staggerLines =
        a.horiz && s.staggerLines;
      if (!a.axisGroup)a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).add(da), a.axisGroup = c.g("axis").attr({zIndex: d.zIndex || 2}).add(da), a.labelGroup = c.g("axis-labels").attr({zIndex: s.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels").add(da);
      if (j || a.isLinked) {
        if (n(e, function (b) {
      ...
      if (u && u.text && u.enabled !== !1) {
        if (!a.axisTitle)a.axisTitle = c.text(u.text, 0, 0, u.useHTML).attr({
          ...
          align: u.textAlign || {low: y ? "right" : "left", middle: "center", high: y ? "left" : "right"}[u.align]
    ...
    getTitlePosition: function () {
      ...
      return {
        x: a ? d + i : b + (g ? this.width : 0) + h + i, y: a ? b + j - (g ? this.height :
          0) + h : d + j
      }
    },
    render: function () {
      var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.isLog, f = a.isLinked, g = a.tickPositions, h = a.axisTitle, i = a.ticks, j = a.minorTicks, k = a.alternateBands, l = d.stackLabels, m = d.alternateGridColor, o = a.tickmarkOffset, u = d.lineWidth, s, p = b.hasRendered && r(a.oldMin) && !isNaN(a.oldMin), y = a.showAxis, E = c.globalAnimation, v, q;
      ...
      n([i, j, k], function (a) {
        var c, d, e = [], f = E ? E.duration || 500 : 0;
    ...
    drawCrosshair: function (a, b) {
      ...
      if (!this.crosshair || (r(b) || !p(d.snap, !0)) === !1 || b && b.series && b.series[this.coll] !== this)this.hideCrosshair(); else if (p(d.snap, !0) ? r(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) : c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos, c = this.isRadial ?
  ...
  Z.prototype.getLogTickPositions = function (a, b, c, d) {
    ...
    if (a >= 0.5)a = x(a), g = this.getLinearTickPositions(a, b, c); else if (a >= 0.08)for (var f = fa(b), h, i, j, k, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
      i = e.length;
  ...
  Kb.prototype = {
    init: function (a, b) {
      ...
      var c, d = this.chart, e = d.inverted, f = d.plotTop, g = d.plotLeft, h =
        0, i = 0, j, k, a = qa(a);
      c = a[0].tooltipPos;
      ...
      var d = this.chart, e = this.distance, f = {}, g = c.h || 0, h, i = ["y", d.chartHeight,
        b, c.plotY + d.plotTop, d.plotTop, d.plotTop + d.plotHeight], j = ["x", d.chartWidth, a, c.plotX + d.plotLeft, d.plotLeft, d.plotLeft + d.plotWidth], k = p(c.ttBelow, d.inverted && !c.negative || !d.inverted && c.negative), l = function (a, b, c, d, h, i) {
        var j = c < d - e, l = d + e + c < b, m = d - e - c;
        d += e;
        if (k && l)f[a] = d; else if (!k && j)f[a] = m; else if (j)f[a] = I(i - c, m - g < 0 ? m : m - g); else if (l)f[a] = v(h, d + g + c > b ? d : d + g); else return !1
      }, m = function (a, b, c, d) {
        var g;
      ...
      var c = b ? "footer" : "header", d = a.series, e = d.tooltipOptions, f = e.xDateFormat, g = d.xAxis, h = g && g.options.type ===
        "datetime" && ma(a.key), c = e[c + "Format"];
  ...
  Aa.prototype = {
    init: function (a, b) {
      var c = b.chart, d = c.events, e = ka ? "" : c.zoomType, c =
        a.inverted, f;
      this.options = b;
      this.chart = a;
      ...
      return q(a, {chartX: x(c), chartY: x(d)})
      ...
      var b = this.chart, c = b.series, d = b.tooltip, e = d ? d.shared : !1, f = b.hoverPoint, g = b.hoverSeries, h, i = Number.MAX_VALUE, j, k, l,
        m = [], o, u;
      ...
      var b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY, f = this.zoomHor, g = this.zoomVert, h = b.plotLeft, i = b.plotTop, j = b.plotWidth, k = b.plotHeight, l, m = this.selectionMarker, o = this.mouseDownX, u = this.mouseDownY, s = c.panKey && a[c.panKey + "Key"];
      if (!m || !m.touch)if (d < h ? d = h : d > h + j && (d = h + j), e < i ? e = i : e > i + k && (e = i + k), this.hasDragged = Math.sqrt(Math.pow(o - d, 2) + Math.pow(u - e, 2)), this.hasDragged >
        10) {
        ...
        m && g && (d = e - u, m.attr({height: Q(d), y: (d > 0 ? 0 : d) + u}));
        l && !m && c.panning && b.pan(a, c.panning)
      }
    }, drop: function (a) {
      var b = this, c = this.chart, d = this.hasPinched;
      if (this.selectionMarker) {
        var e = {xAxis: [], yAxis: []}, f = this.selectionMarker, g = f.attr ?
          f.attr("x") : f.x, h = f.attr ? f.attr("y") : f.y, i = f.attr ? f.attr("width") : f.width, j = f.attr ? f.attr("height") : f.height, k;
        if (this.hasDragged || d)n(c.axes, function (c) {
          if (c.zoomEnabled && r(c.min) && (d || b[{xAxis: "zoomX", yAxis: "zoomY"}[c.coll]])) {
            var f = c.horiz, o = a.type === "touchend" ? c.minPixelPadding : 0, u = c.toValue((f ? g : h) + o), f = c.toValue((f ? g + i : h + j) - o);
            e[c.coll].push({axis: c, min: I(u, f), max: v(u, f)});
            k = !0
          }
      ...
      b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (M(c.series, "click", q(a, {point: c})), b.hoverPoint && c.firePointEvent("click", a)) :
  ...
  q(t.Pointer.prototype, {
    pinchTranslate: function (a, b, c, d, e, f) {
      ...
      (this.zoomVert || this.pinchVert) && this.pinchTranslateDirection(!1, a, b, c, d, e, f)
                                          ...
                                          b, c, d, e, f, g, h) {
      var i = this.chart, j = a ? "x" : "y", k = a ? "X" : "Y", l = "chart" + k, m = a ? "width" : "height", o = i["plot" + (a ? "Left" : "Top")], u, s, n = h || 1, p = i.inverted, E = i.bounds[a ? "h" : "v"], v = b.length === 1, q = b[0][l], r = c[0][l], w = !v && b[1][l], t = !v && c[1][l], x, c = function () {
      ...
      if (a.type === "touchstart")n(e, function (a, b) {
        ...
        if (a.zoomEnabled) {
          var b = c.bounds[a.horiz ? "h" : "v"], d = a.minPixelPadding, e = a.toPixels(p(a.options.min, a.dataMin)), f = a.toPixels(p(a.options.max, a.dataMax)), g = I(e, f), e = v(e, f);
          b.min = I(a.pos, g - d);
          b.max = v(a.pos + a.len, e + d)
        }
      }), b.res = !0; else if (d.length) {
        if (!i)b.selectionMarker = i = q({destroy: U, touch: !0}, c.plotBox);
  ...
  bb.prototype = {
    init: function (a, b) {
      var c =
        this, d = b.itemStyle, e = b.itemMarginTop || 0;
      this.options = b;
      ...
      e && e.attr({stroke: h});
      if (f) {
        if (g && f.isMarker)for (j in i.stroke = h, g = a.convertAttribs(g), g)d = g[j], d !== w && (i[j] = d);
        f.attr(i)
      }
    ...
    renderTitle: function () {
      ...
      var b =
        this.chart, c = b.renderer, d = this.options, e = d.layout === "horizontal", f = this.symbolWidth, g = d.symbolPadding, h = this.itemStyle, i = this.itemHiddenStyle, j = this.padding, k = e ? p(d.itemDistance, 20) : 0, l = !d.rtl, m = d.width, o = d.itemMarginBottom || 0, u = this.itemMarginTop, s = this.initialItemX, n = a.legendItem, y = a.series && a.series.drawLegendSymbol ? a.series : a, E = y.options, E = this.createCheckboxForItem && E && E.showCheckbox, q = d.useHTML;
      if (!n) {
      ...
      n(this.chart.series, function (b) {
        var c = b.options;
        if (p(c.showInLegend,
            !r(c.linkedTo) ? w : !1, !0))a = a.concat(b.legendItems || (c.legendType === "point" ? b.data : b))
      });
      return a
      ...
      var a = this, b =
        a.chart, c = b.renderer, d = a.group, e, f, g, h, i = a.box, j = a.options, k = a.padding, l = j.borderWidth, m = j.backgroundColor;
      ...
      f &&
      d.align(q({width: g, height: h}, j), !0, "spacingBox");
      b.isResizing || this.positionCheckboxes()
    }, handleOverflow: function (a) {
      var b = this, c = this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height + (e.verticalAlign === "top" ? -f : f) - this.padding, g = e.maxHeight, h, i = this.clipRect, j = e.navigation, k = p(j.animation, !0), l = j.arrowSize || 12, m = this.nav, o = this.pages, u = this.padding, s, q = this.allItems, y = function (a) {
        i.attr({height: a});
      ...
      if (a > f) {
        ...
        y(h);
        if (!m)this.nav = m = d.g().attr({zIndex: 1}).add(this.group), this.up = d.symbol("triangle",
        ...
        b.scroll(0);
        a = f
      } else if (m)y(c.chartHeight), m.hide(), this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0;
      return a
    }, scroll: function (a, b) {
  ...
  ha.prototype = {
    callbacks: [], getArgs: function () {
      ...
      var b = this.axes, c = this.series, d = this.pointer, e = this.legend, f = this.isDirtyLegend, g, h, i = this.hasCartesianSeries, j = this.isDirtyBox, k = c.length, l = k, m = this.renderer, o = m.isHidden(), u = [];
      Wa(a, this);
    ...
    setTitle: function (a, b, c) {
      ...
      var b = 0, c = this.title, d = this.subtitle, e = this.options, f = e.title, e = e.subtitle, g = this.renderer, h =
      ...
      d && (d.css({width: (e.width || h) + "px"}).align(q({y: b + (f.margin - 13) + g.fontMetrics(e.style.fontSize, c).b}, e), !1, "spacingBox"), !e.floating && !e.verticalAlign && (b = ra(b + d.getBBox().height)));
    ...
    getChartSize: function () {
      ...
      var b = this, c = b.options.chart, d = b.renderTo, e = c.width || Da(d, "width"), f = c.height || Da(d, "height"), c = a ? a.target : C;
      ...
      a = g.globalAnimation;
      (a ? Ta : F)(d.container, {width: e + "px", height: f + "px"}, a);
      d.setChartSize(!0);
      g.setSize(e,
        f, c);
      d.maxTicks = null;
      ...
      c = ra(v(d, h[0]) / 2);
      this.clipBox = {
        x: b, y: c, width: fa(this.plotSizeX - v(d, h[1]) / 2 - b),
      ...
      var a = this.options.chart, b = this.renderer, c = this.chartWidth, d = this.chartHeight, e = this.chartBackground, f = this.plotBackground, g = this.plotBorder, h = this.plotBGImage, i = a.borderWidth || 0, j = a.backgroundColor, k = a.plotBackgroundColor, l = a.plotBackgroundImage,
        m = a.plotBorderWidth || 0, o, n = this.plotLeft, p = this.plotTop, q = this.plotWidth, y = this.plotHeight, E = this.plotBox, v = this.clipRect, r = this.clipBox;
      o = i + (a.shadow ? 8 : 0);
      ...
      if (k)f ? f.animate(E) : this.plotBackground = b.rect(n, p, q, y, 0).attr({fill: k}).add().shadow(a.plotShadow);
      if (l)h ? h.animate(E) : this.plotBGImage = b.image(l, n, p, q, y).add();
      v ? v.animate({width: r.width, height: r.height}) : this.clipRect = b.clipRect(r);
  ...
  S.prototype = {
    ...
    setData: function (a, b, c, d) {
      var e = this, f = e.points, g = f && f.length ||
        0, h, i = e.options, j = e.chart, k = null, l = e.xAxis, m = l && !!l.categories, o = i.turboThreshold, u = this.xData, s = this.yData, q = (h = e.pointArrayMap) && h.length, a = a || [];
      h = a.length;
      b = p(b, !0);
      if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible)n(a, function (a, b) {
        ...
        if (o && h > o) {
          ...
          if (ma(k)) {
            ...
            e.xIncrement = m
          } else if (Fa(k))if (q)for (c = 0; c < h; c++)k = a[c], u[c] = k[0], s[c] = k.slice(1, q + 1); else for (c = 0; c < h; c++)k = a[c], u[c] = k[0], s[c] = k[1]; else T(12)
        } else for (c = 0; c < h; c++)if (a[c] !== w && (k = {series: e}, e.pointClass.prototype.applyOptions.apply(k, [a[c]]), e.updateParallelArrays(k, c), m && r(k.name)))l.names[k.x] = k.name;
        ta(s[0]) && T(14, !0);
        e.data = [];
        e.options.data = a;
    ...
    processData: function (a) {
      ...
      i = j.cropThreshold;
      var j = this.getExtremesFromAll || j.getExtremesFromAll, k = this.isCartesian, l, m;
      if (k && !this.isDirty && !h.isDirty && !this.yAxis.isDirty && !a)return !1;
      if (h)a = h.getExtremes(), l = a.min, m = a.max;
      if (k && this.sorted && !j && (!i || d > i || this.forceCrop))if (b[d - 1] < l || b[0] > m)b = [], c = []; else if (b[0] < l || b[d - 1] > m)e =
    ...
    getExtremes: function (a) {
      ...
      d = a.length;
      for (l = 0; l < d; l++)if (j = c[l], k = a[l], i = k !== null && k !== w && (!b.isLog || k.length || k > 0), j = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[l + 1] || j) >= g && (c[l - 1] || j) <= h, i && j)if (i = k.length)for (; i--;)k[i] !== null && (e[f++] = k[i]); else e[f++] = k;
      this.dataMin = Va(e);
      this.dataMax = Ha(e)
    },
    translate: function () {
    ...
    drawPoints: function () {
      var a, b = this.points, c = this.chart, d, e, f, g, h, i, j, k, l = this.options.marker, m = this.pointAttr[""], o, n, s, v = this.markerGroup, y = p(l.enabled, this.xAxis.isRadial, this.closestPointRangePx > 2 * l.radius);
      if (l.enabled !== !1 || this._hasPointMarkers)for (f = b.length; f--;)if (g = b[f], d = fa(g.plotX), e = g.plotY, k = g.graphic, o = g.marker || {}, n = !!g.marker, a = y && o.enabled === w || o.enabled, s = g.isInside, a && e !== w && !isNaN(e) && g.y !== null)if (a = g.pointAttr[g.selected ? "select" : ""] || m, h = a.r, i = p(o.symbol, this.symbol), j = i.indexOf("url") ===
          0, k)k[s ? "show" : "hide"](!0).animate(q({x: d - h, y: e - h}, k.symbolName ? {
        width: 2 * h,
        height: 2 * h
      } : {})); else {
    ...
    getAttribs: function () {
      var a = this, b = a.options, c = X[a.type].marker ? b.marker : b, d = c.states, e = d.hover, f, g = a.color, h = a.options.negativeColor;
      f = {stroke: g, fill: g};
      var i = a.points || [], j, k, l = [], m = a.pointAttrToOptions;
      j = a.hasPointSpecificOptions;
      var o = c.lineColor, u = c.fillColor;
      k = b.turboThreshold;
      var s = a.zones, v = a.zoneAxis || "y", y;
      ...
      if (!k || g < k || j)for (; g--;) {
        ...
        if (k.options)for (y in m)r(c[m[y]]) && (j = !0);
        if (j) {
          c = c || {};
          j = [];
          d = c.states || {};
    ...
    applyZones: function () {
      var a = this, b = this.chart, c = b.renderer, d = this.zones,
        e, f, g = this.clips || [], h, i = this.graph, j = this.area, k = v(b.chartWidth, b.chartHeight), l = this[(this.zoneAxis || "y") + "Axis"], m, o = l.reversed, u = b.inverted, s = l.horiz, q, y, r, t = !1;
      if (d.length && (i || j) && l.min !== w)i && i.hide(), j && j.hide(), m = l.getExtremes(), n(d, function (d, n) {
        ...
        r = v(e, f);
        if (l.isXAxis) {
          if (h = {x: u ? r : y, y: 0, width: q, height: k}, !s)h.x = b.plotHeight - h.x
        } else if (h =
          {x: 0, y: u ? r : y, width: k, height: q}, s)h.y = b.plotWidth - h.y;
    ...
    getPlotBox: function () {
      ...
      return {
        translateX: b ? b.left : a.plotLeft, translateY: c ? c.top : a.plotTop,
        scaleX: 1, scaleY: 1
      }
    },
    render: function () {
    ...
    searchKDTree: function (a, b) {
      function c(a, b, j, k) {
        var l = b.point, m = d.kdAxisArray[j % k], o, n, p = l;
  ...
  q(ha.prototype, {
    addSeries: function (a, b, c) {
      ...
      new Z(this, B(a, {index: this[e].length, isX: b}));
      f[e] = qa(f[e] || {});
      f[e].push(a);
      p(c, !0) && this.redraw(d)
      ...
      if (!d)b.loadingDiv = d = ca(Ia, {className: "highcharts-loading"}, q(e.style, {
        zIndex: 10,
        display: "none"
      }), b.container),
      ...
      if (!b.loadingShown)F(d, {
        opacity: 0,
        display: ""
      }), Ta(d, {opacity: e.style.opacity}, {duration: e.showDuration || 0}), b.loadingShown = !0;
      f()
  ...
  q(S.prototype, {
    addPoint: function (a, b, c, d) {
      var e = this, f = e.options, g = e.data, h = e.graph, i = e.area, j = e.chart, k = e.xAxis && e.xAxis.names, l = h && h.shift || 0, m = ["graph", "area"], h = f.data, o, u = e.xData;
      Wa(d, j);
      if (c) {
      ...
      m = i.x;
      d = u.length;
      if (e.requireSorting && m < u[d - 1])for (o = !0; d && u[d - 1] > m;)d--;
    ...
    removePoint: function (a, b, c) {
      ...
      M(c, "remove", null, function () {
        ...
        p(a, !0) && d.redraw(b)
                         ...
                         b) {
      var c = this, d = this.chart, e = this.userOptions, f = this.type, g = z[f].prototype, h = ["group", "markerGroup", "dataLabelsGroup"], i;
  ...
  O = aa(S, {
    ...
    getColumnMetrics: function () {
      ...
      var i = I(Q(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len), j = i * b.groupPadding, k = (i - 2 * j) / h, b = I(b.maxPointWidth || c.len, p(b.pointWidth, k * (1 - 2 * b.pointPadding)));
      a.columnMetrics = {
        width: b,
    ...
    translate: function () {
      var a = this, b = a.chart, c = a.options, d = a.borderWidth = p(c.borderWidth, a.closestPointRange * a.xAxis.transA < 2 ? 0 : 1), e = a.yAxis, f = a.translatedThreshold = e.getThreshold(c.threshold), g = p(c.minPointLength, 5), h = a.getColumnMetrics(), i = h.width, j = a.barW = v(i, 1 + 2 * d), k = a.pointXOffset = h.offset;
      b.inverted && (f -= 0.5);
      c.pointPadding && (j = ra(j));
      S.prototype.translate.apply(a);
      n(a.points, function (c) {
        var d = I(p(c.yBottom, f), 9E4), h = 999 + Q(d), h = I(v(-h, c.plotY), e.len + h), n = c.plotX + k, s = j, q = I(h, d), y, r = v(h, d) - q;
  ...
  S.prototype.drawDataLabels = function () {
    ...
    if (d.enabled || a._hasPointLabels)a.dlProcessOptions && a.dlProcessOptions(d), j = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), p(d.defer, !0) && (j.attr({opacity: +h}), h || G(a, "afterAnimate", function () {
      a.visible && j.show();
      j[b.animation ? "animate" : "attr"]({opacity: 1}, {duration: 200})
    })), g = d, n(e, function (e) {
      var h, o = e.dataLabel, n,
        s, v = e.connector, y = !0, t, x = {};
      ...
      if (o && !h)e.dataLabel = o.destroy(); else if (h) {
        ...
        if (o)if (r(i))o.attr({text: i}), y = !1; else {
  ...
  S.prototype.alignDataLabel = function (a, b, c, d, e) {
    var f = this.chart, g = f.inverted, h = p(a.plotX, -9999), i = p(a.plotY, -9999), j = b.getBBox(), k = f.renderer.fontMetrics(c.style.fontSize).b,
    ...
    }).attr({align: c.align})) : (b.align(c, null, d), g = b.alignAttr, p(c.overflow, "justify") === "justify" ? this.justifyDataLabel(b, c, g, j, d, e) : p(c.crop, !0) && (l = f.isInsidePlot(g.x, g.y) &&
      f.isInsidePlot(g.x + j.width, g.y + j.height)), c.shape && b.attr({anchorX: a.plotX, anchorY: a.plotY}));
    if (!l)Ka(b), b.attr({y: -9999}), b.placed = !1
  };
  ...
  if (z.pie)z.pie.prototype.drawDataLabels = function () {
    var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = p(e.connectorPadding, 10), g = p(e.connectorWidth, 1), h = d.plotWidth, i = d.plotHeight, j, k, l = p(e.softConnector, !0), m = e.distance, o = a.center, u = o[2] / 2, s = o[1], q = m > 0, r, t, w, B = [[], []], A, z, C, D, L, F = [0, 0, 0, 0], M = function (a, b) {
      return b.y - a.y
    };
    if (a.visible && (e.enabled || a._hasPointLabels)) {
      ...
      for (D = 2; D--;) {
        ...
        if (K) {
          ...
          if (m > 0) {
            ...
            for (L = 0; L < K; L++) {
              ...
              for (O = 0; O < t; O++)P = Q(G[O] - w[1]), P < c && (c = P,
                J = O);
              if (J < L && G[L] !== null)J = L; else for (t < K - L + J && G[L] !== null && (J = t - K + L); G[J] === null;)J++;
              N.push({i: J, y: G[J]});
              G[J] = null
            }
            N.sort(M)
          ...
          for (L = 0; L < K; L++) {
            ...
            r._attr = {visibility: C, align: w[6]};
            r._pos = {x: A + e.x + ({left: f, right: -f}[w[6]] || 0), y: z + e.y - 10};
            r.connX = A;
            r.connY =
              z;
      ...
      if (Ha(F) === 0 || this.verifyDataLabelOverflow(F))this.placeDataLabels(), q && g && n(this.points, function (b) {
        ...
        if ((r = b.dataLabel) && r._pos && b.visible)C = r._attr.visibility, A = r.connX, z = r.connY, k = l ? ["M", A + (w[6] === "left" ? 5 : -5), z, "C", A, z, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], "L", w[4], w[5]] : ["M", A + (w[6] === "left" ? 5 : -5), z, "L",
          w[2], w[3], "L", w[4], w[5]], j ? (j.animate({d: k}), j.attr("visibility", C)) : b.connector = j = a.chart.renderer.path(k).attr({
          "stroke-width": g,
  ...
  (function (a) {
    ...
    b.prototype.hideOverlappingLabels = function (a) {
      ...
      for (e = 0; e < b; e++) {
        j = a[e];
        for (d = e + 1; d < b; ++d)if (k = a[d], j && k && j.placed && k.placed && j.newOpacity !== 0 && k.newOpacity !== 0 && (l = j.alignAttr, m = k.alignAttr, o = 2 * (j.box ? 0 : j.padding), l = !(m.x > l.x + (j.width - o) || m.x + (k.width - o) < l.x || m.y > l.y + (j.height -
  ...
  q(db.prototype, {
    defaultColorAxisOptions: {
      ...
      d = B(this.defaultColorAxisOptions, {side: c ? 2 : 1, reversed: !c}, b, {
        opposite: !c,
        showEmpty: !1,
        title: null,
        isColor: !0
      ...
      if (b)e = this.toPixels(b[b.series.colorKey]), e < f ? e = f - 2 : e > f + g && (e = f + g + 2), b.plotX = e, b.plotY = this.len - e, Z.prototype.drawCrosshair.call(this, a, b), b.plotX = c, b.plotY = d, this.cross && this.cross.attr({fill: this.crosshair.color}).add(this.legendGroup)
    }, getPlotLinePath: function (a, b, c, d, e) {
  ...
  var Mb = aa($, q({
    applyOptions: function (a, b) {
      ...
      var a = this, b = +new xa, c = P(a.color), d = P(a.pointAttr.hover.fill), e = a.series.options.states.normal.animation, f = e && (e.duration || 500), g;
  ...
  z.map = aa(z.scatter, B(Lb, {
    ...
    getBox: function (a) {
      ...
      n(a || [], function (a) {
        if (a.path) {
          ...
          var h = a.path || [], i = h.length, o = !1, n = -b, s = b, q = -b, r = b, v = a.properties;
          if (!a._foundBox) {
    ...
    setData: function (a, b) {
      ...
      if (d) {
        ...
        c.allAreas && (a = a || [], e[1] && n(a, function (a) {
          ...
          (!e[0] || g.indexOf("|" + b[e[0]] + "|") === -1) && a.push(B(b, {value: null}))
        }))
      }
    ...
    translate: function () {
      ...
      n(a.data, function (e) {
        ...
        if (d)e.shapeType = "path", e.shapeArgs = {d: a.translatePath(e.path)}, lb && (e.shapeArgs["vector-effect"] = "non-scaling-stroke")
      });
      a.translateColors()
    },
    drawPoints: function () {
      var a = this, b = a.xAxis, c = a.yAxis, d = a.group, e = a.chart, f = e.renderer, g, h = this.baseTrans;
      if (!a.transformGroup)a.transformGroup = f.g().attr({scaleX: 1, scaleY: 1}).add(d), a.transformGroup.survive = !0;
    ...
    render: function () {
      var a = this, b = S.prototype.render;
    ...
    animateDrilldown: function (a) {
      ...
      if (!a)a = Math.min(d.width / b.width, d.height / b.height), c.shapeArgs = {
        ...
        function (a) {
          a.graphic && a.graphic.attr(c.shapeArgs).animate({scaleX: 1, scaleY: 1, translateX: 0, translateY: 0}, e)
        }), this.animate = null
    },
    drawLegendSymbol: cb.drawRectangle,
  ...
  q(ha.prototype, {
    renderMapNavigation: function () {
      var a =
        this, b = this.options.mapNavigation, c = b.buttons, d, e, f, g, h = function (a) {
        if (a)a.preventDefault && a.preventDefault(), a.stopPropagation && a.stopPropagation(), a.cancelBubble = !0
      }, i = function (b) {
        this.handler.call(a, b);
        h(b)
      };
      if (p(b.enableButtons, b.enabled) && !a.renderer.forExport)for (d in c)if (c.hasOwnProperty(d))f = B(b.buttonOptions, c[d]), e = f.theme, e.style = B(f.theme.style, f.style), g = e.states, e = a.renderer.button(f.text, 0, 0, i, e, g && g.hover, g && g.select, 0, d === "zoomIn" ? "topbutton" : "bottombutton").attr({
        width: f.width,
        height: f.height, title: a.options.lang[d], zIndex: 5
      ...
      var f = this.xAxis[0], g = f.max - f.min, h = p(b, f.min + g / 2), i = g * a, g = this.yAxis[0], j = g.max - g.min,
        k = p(c, g.min + j / 2);
      j *= a;
      h = this.fitToBox({
  ...
  q(Aa.prototype, {
    onContainerDblClick: function (a) {
      ...
      b.options.mapNavigation.enableDoubleClickZoomTo ? b.pointer.inClass(a.target, "highcharts-tracker") && b.hoverPoint.zoomTo() :
  ...
  X.mapline = B(X.map, {lineWidth: 1, fillColor: "none"});
  z.mapline = aa(z.map, {
    type: "mapline",
  ...
  z.mappoint = aa(z.scatter, {
    type: "mappoint", forceDL: !0, pointClass: aa($, {
      applyOptions: function (a, b) {
  ...
  z.bubble = aa(z.scatter, {
    ...
    getRadii: function (a, b, c, d) {
      var e, f, g, h = this.zData, i = [], j = this.options,
        k = j.sizeBy !== "width", l = j.zThreshold, m = b - a;
    ...
    translate: function () {
      ...
      for (a = b.length; a--;)c = b[a], d = e ? e[a] : 0, typeof d === "number" && d >= this.minPxSize / 2 ? (c.shapeType = "circle", c.shapeArgs = {
        ...
        y: c.plotY,
        r: d
      }, c.dlBox = {x: c.plotX - d, y: c.plotY - d, width: 2 * d, height: 2 * d}) : c.shapeArgs = c.plotY = c.dlBox = w
    },
    drawLegendSymbol: function (a, b) {
  ...
  Z.prototype.beforePadding = function () {
    var a = this, b = this.len, c = this.chart, d = 0, e = b, f = this.isXAxis, g = f ? "xData" : "yData", h = this.min, i = {}, j = N.min(c.plotWidth, c.plotHeight), k = Number.MAX_VALUE, l = -Number.MAX_VALUE, m = this.max - h, o = b / m, q = [];
    n(this.series, function (b) {
      var d = b.options;
      if (b.bubblePadding && (b.visible || !c.options.chart.ignoreHiddenSeries))if (a.allowZoomOutside = !0, q.push(b), f)n(["minSize", "maxSize"], function (a) {
        var b = d[a],
          c = /%$/.test(b), b = D(b);
        i[a] = c ? j * b / 100 : b
    ...
    n(q, function (a) {
      ...
      if (m > 0)for (; c--;)typeof b[c] === "number" && (i = a.radii[c], d = Math.min((b[c] - h) * o - i, d), e = Math.max((b[c] - h) * o + i, e))
    });
    q.length && m > 0 && !this.isLog && (e -= b, o *= (b + d - e) / b, n([["min", "userMin", d], ["max", "userMax",
      e]], function (b) {
  ...
  if (z.bubble)X.mapbubble = B(X.bubble, {
    ...
    }), xyFromShape: !0, type: "mapbubble", pointArrayMap: ["z"], getMapData: z.map.prototype.getMapData,
    getBox: z.map.prototype.getBox, setData: z.map.prototype.setData
  });
  ha.prototype.transformFromLatLon = function (a, b) {
    if (C.proj4 === void 0)return T(21), {x: 0, y: null};
    var c = C.proj4(b.crs, [a.lon, a.lat]), d = b.cosAngle || b.rotation && Math.cos(b.rotation), e = b.sinAngle || b.rotation && Math.sin(b.rotation), c = b.rotation ? [c[0] * d + c[1] * e, -c[0] * e + c[1] * d] : c;
    return {
  ...
  ha.prototype.transformToLatLon = function (a, b) {
    if (C.proj4 === void 0)T(21); else {
      ...
      }, d = b.cosAngle || b.rotation && Math.cos(b.rotation), e = b.sinAngle || b.rotation && Math.sin(b.rotation), c = C.proj4(b.crs, "WGS84", b.rotation ? {
        x: c.x * d + c.y * -e,
        y: c.x * e + c.y * d
      } : c);
  ...
  ha.prototype.fromPointToLatLon = function (a) {
    var b = this.mapTransforms,
      c;
    if (b) {
      for (c in b)if (b.hasOwnProperty(c) && b[c].hitZone && Eb({
          x: a.x,
          y: -a.y
  ...
  ha.prototype.fromLatLonToPoint = function (a) {
    ...
    if (!b)return T(22), {x: 0, y: null};
    for (c in b)if (b.hasOwnProperty(c) && b[c].hitZone && (d = this.transformFromLatLon(a, b[c]), Eb({
        x: d.x,
        y: -d.y
    ...
    function (a, b, c) {
      ...
      n(a.features, function (a) {
        ...
        b === "map" || b === "mapbubble" ? (i === "Polygon" ? (n(c, f), e.push("Z")) : i === "MultiPolygon" && (n(c, function (a) {
          n(a, f)
        }), e.push("Z")), e.length && (j = {path: e})) : b === "mapline" ? (i === "LineString" ? f(c) : i === "MultiLineString" && n(c, f), e.length && (j = {path: e})) : b === "mappoint" && i === "Point" && (j =
        {x: c[0], y: -c[1]});
  ...
  t.Map = t.mapChart = function (a, b, c) {
    var d = typeof a === "string" || a.nodeName, e = arguments[d ? 1 : 0], f = {
      endOnTick: !1, gridLineWidth: 0, lineWidth: 0, minPadding: 0, maxPadding: 0, startOnTick: !1, title: null,
      tickPositions: []
    }, g;
    g = e.series;
    e.series = null;
    e = B({chart: {panning: "xy", type: "map"}, xAxis: f, yAxis: B(f, {reversed: !0})}, e, {
      chart: {
        inverted: !1,
        alignTicks: !1
      }
  ...
  La = t.TrackerMixin = {
    drawTrackerPoint: function () {
      ...
      var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath), e = d.length, f = a.chart, g = f.pointer,
        h = f.renderer, i = f.options.tooltip.snap, j = a.tracker, k = b.cursor, l = k && {cursor: k}, k = a.singlePoints, m, o = function () {
      ...
      j ? j.attr({d: d}) : (a.tracker = h.path(d).attr({
        "stroke-linejoin": "round", visibility: a.visible ? "visible" :
          "hidden", stroke: p, fill: c ? p : "none", "stroke-width": b.lineWidth + (c ? 0 : 2 * i), zIndex: 2
  ...
  q(ha.prototype, {
    showResetZoom: function () {
      var a = this, b = H.lang, c = a.options.chart.resetZoomButton, d = c.theme, e = d.states, f = c.relativeTo === "chart" ? null : "plotBox";
    ...
    zoomOut: function () {
      ...
      n(b === "xy" ? [1, 0] : [1], function (b) {
        ...
        if (h.series.length && (i || l > I(k.dataMin, k.min)) && (!i || j < v(k.dataMax, k.max)))h.setExtremes(l, j, !1, !1, {trigger: "pan"}), e = !0;
  ...
  q($.prototype, {
    select: function (a, b) {
      ...
      var c = fa(this.plotX), d = this.plotY, e = this.series, f = e.options.states, g = X[e.type].marker && e.options.marker, h = g && !g.enabled, i = g && g.states[a], j = i && i.enabled === !1, k = e.stateMarkerGraphic, l = this.marker || {}, m = e.chart, o = e.halo, n, a = a || "";
